...
import { useUiStore, type PixelScale } from "@/lib/store/useUiStore";
...
export function SettingsModal() {
  ...
  return (
    <dialog
      ref={dialogRef}
      onClose={close}
      className="settings-dialog w-80 border-4 border-ink bg-cream-dark p-0"
      style={{
        boxShadow:
    ...
    >
      <div className="p-4">
        ...
        <section className="mb-4">
          <h3 className="mb-2 font-ui text-[10px] text-ink">Pixel scale</h3>
        ...
        <section className="flex flex-col gap-2">
          <h3 className="font-ui text-[10px] text-ink">Accounts</h3>
